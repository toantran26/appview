...
part of 'master_data_remote_source.dart';
...
class _MasterDataRemoteSource implements MasterDataRemoteSource {
  ...
  @override
  Future<List<Category>> getCategoriesMenu() async {
  ...
  @override
  Future<List<BannerResponse>> getTopHomeBanner() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<List<BannerResponse>> getMiddleHomeBanner() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
