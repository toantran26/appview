...
class Render9NewsUnderMedia extends StatefulWidget {
  const Render9NewsUnderMedia({Key? key}) : super(key: key);

  @override
  State<Render9NewsUnderMedia> createState() => _Render9NewsUnderMediaState();
}

class _Render9NewsUnderMediaState extends State<Render9NewsUnderMedia> {
  final NewsDataRemoteSource _newsDataRemoteSource = Get.find();

  @override
  Widget build(BuildContext context) {
    return FutureRender<List<NewsIntro>>(
      future: _newsDataRemoteSource.get9NewsUnderMedia(),
